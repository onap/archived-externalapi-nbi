...
public class OrderItemRelationship {
     ...
     **/
    @JsonProperty("type")
    @ApiModelProperty(required = true, value = "The type of related order item, can be : dependancy if the order item needs to be “not started” until another order item is complete")
    @NotNull
